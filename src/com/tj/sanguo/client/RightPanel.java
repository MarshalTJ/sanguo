...
//	private Label lb_armyInfo = new Label();
	...
	private void refreshProductInfo() {
		...
		info_wood.append("  木:").append(ownWood.getNumsToInt()).append("/").append(volumen).append("/").append(productWood.getNums());
		info_iron.delete(0, info_iron.length());
		info_iron.append("  铁:").append(ownIron.getNumsToInt()).append("/").append(volumen).append("/").append(productIron.getNums());
		info_food.delete(0, info_food.length());
		info_food.append("  粮:").append(ownFood.getNumsToInt()).append("/").append(volumen).append("/").append(productFood.getNums()).append("/").append(MonarchHolder.MYSELF.getChooseCity().getPopulation());
